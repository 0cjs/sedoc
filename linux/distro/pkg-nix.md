...
Environments:
- `HASH-user-environment/`: an environment directory tree in $PREFIX format.
- `HASH-env-manifest.nix`: the  expression used to derive a user
  environment above (`HASH-PNAME-PVER/manifest.nix` symlink to these)
