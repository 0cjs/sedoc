...
* __'00__ (14): Quad 2-input NAND gate [SN74LS00]
  ...
  - __'01, '03__ are open-collector versions (different pinouts?)
...
* __'374__ (20): Octal D-Type Edge-Triggered Flip-Flops [SN54LS373]
...
* __'257, '258__ (16): 4× 2→1 selector/multiplexer [SN54LS257B]
  ...
  - __'157, '158__ [SN74LS157] are non-tri-state (L, H when not selected)
...
* __'240, '241, '244__ (20): Octal Buffers/Line Drivers, 3-State [SN74LS240]
  ...
  - __'540, '541__ [SN54LS540]: one 2-input enable for all 8 latches,
    inputs/outputs on opposite sides of package for easier routing
