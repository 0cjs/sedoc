...
| 5V Logic | min LOW | LOW max | min HIGH | HIGH max |
|---------:|--------:|:--------|---------:|:---------|
| CMOS  IN |     0.0 | 1.5     |     3.5  | 5.0      |
|  TTL  IN |     0.0 | 0.8     |     2.0  | 5.0      |
|  TTL OUT |     0.0 | 0.5     |     2.7  | 5.0      |
| CMOS OUT |     0.0 | 0.05    |     4.95 | 5.00     |
...
Sources: [Radical Brad's VIC-20 JetPack][rbv20]. [Sparkfun: Logic Levels][spark-levels].
