...
Items marked ✓ have been checked on my FM77AV, and in these cases "output"
definitely means "output from computer." Currently, all checks were done
with a cable unconnected at the external end, except to the 'scope. RGB
