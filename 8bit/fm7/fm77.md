...
- FM-77:
  - Top row: large slot for cables from cards. IEC C14 inlet, NEMA 5-15 outlet.
  - Bottom row: "???" DE-9. "CRT" DE-9. "Audio Cassette" miniDIN-?.
    "Printer" mini-ribbon-36. "Keyboard" mini-ribbon-32?.
...
The FM-77 uses a 32?-pin mini-ribbon, which looks like a parallel
