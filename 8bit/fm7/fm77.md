...
- (1987) FM77AV20EX: 128 (max 192) KB.
...
My FM77AV has been confirmed to output RGB on 15,19,20 (grounds 13,17,18)
with separate composite sync on 10 and ground on 14.

Currently, all checks were done with a cable unconnected at the external
end, except to the 'scope, or with RGB and sync connected to a monitor. RGB
appears to function as output with `Ys` left floating.
