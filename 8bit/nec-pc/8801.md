...
- __V3 mode__ available only on __V__ models.
    ...
    n/m = n color palette out of m total colours available
...
Analog RGB DA-15F (upper left is pin 8, see [[dsub]]):
    ...
    13  AVC: colour TV input terminal control signal (TTL positive logic)
    14  H̅S̅Y̅N̅C̅ (TTL)
    15  V̅S̅Y̅N̅C̅ (TTL)
...
information and includes links to other resources.
