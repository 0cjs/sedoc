...
- 19??-?? __PC-8001B:__ European/Australian release (240V), `カナ` key
  became `SHIFT LOCK`; [pictures][retropc.net/404]. Also released with
  __BE__ suffix (UK version) on computer and peripherals, `3/#` key
  replaced with `3/£`; [pictures][80s_john].
